...
{
    /// <inheritdoc />
    public partial class db_hino : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Operators_Zones_zone_id",
                        column: x => x.zone_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    task_duration = table.Column<int>(type: "integer", nullable: false),
                    task_no = table.Column<string>(type: "text", nullable: false),
                    created_by = table.Column<Guid>(type: "uuid", nullable: true),
                    update_by = table.Column<Guid>(type: "uuid", nullable: true),
                    deleted_by = table.Column<Guid>(type: "uuid", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SettingTasks", x => x.id);
                    table.ForeignKey(
                        name: "FK_SettingTasks_Operators_operator_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Operators_zone_id",
                table: "Operators",
                column: "zone_id");

            migrationBuilder.CreateIndex(
                name: "IX_SettingTasks_operator_id",
                table: "SettingTasks",
                column: "operator_id");
        }
